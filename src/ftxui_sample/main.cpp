...
// configuration step. It creates a namespace called `Test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Test::cmake::project_name, Test::cmake::project_version) };
